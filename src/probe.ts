 ...
 */
export const PROBE_EFFORT_CANDIDATES: readonly WorkBuddyAiEffort[] = ['low', 'medium', 'high', 'xhigh', 'max']
...
export type ProbeOutcome =
  | { validation: 'validating'; efforts: readonly WorkBuddyAiEffort[]; requests: number }
...
export async function probeModel(options: {
  ...
  const accepted: WorkBuddyAiEffort[] = []
