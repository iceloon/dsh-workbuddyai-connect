...
//#endregion
export { randomSentinel as A, classifyUpstreamError as C, regionOf as D, prepareChatBody as E, credentialFromPluginToken as F, defaultDesktopAuthCandidates as I, defaultDesktopAuthPath as L, WORKBUDDYAI_AUTH_FILE_ENV as M, WORKBUDDYAI_DESKTOP_AUTH_BASENAME as N, PROBE_EFFORT_CANDIDATES as O, WorkBuddyAiCredentialStore as P, parseWorkBuddyAiAuth as R, WorkBuddyAiUpstreamClient as S, normalizeCredits as T, FALLBACK_FREE_MODEL_IDS as _, readHostHeartbeat as a, parseProductConfig as b, WORKBUDDYAI_CONNECT_VERSION as c, FALLBACK_WORKBUDDYAI_MODELS as d, WorkBuddyAiCatalog as f, FALLBACK_EXTRA_MODELS as g, BUILTIN_FREE_MODELS as h, processStartTimeMs as i, WORKBUDDYAI_AUTH_FILENAME as j, probeModel as k, LOGIN_TIMEOUT_MS as l, BUILTIN_CREDITS as m, clearHostHeartbeat as n, workbuddyAiHostHeartbeatPath as o, composeCatalog as p, isHeartbeatProcessAlive as r, writeHostHeartbeat as s, WORKBUDDYAI_HOST_HEARTBEAT_FILENAME as t, WorkBuddyAiOAuthLogin as u, freeModelIds as v, isFreeCredits as w, workbuddyAiProductConfigPath as x, loadProductConfig as y, workbuddyAiOwnAuthPath as z };
