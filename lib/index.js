import { A as WORKBUDDYAI_DESKTOP_AUTH_BASENAME, C as prepareChatBody, D as randomSentinel, E as probeModel, F as workbuddyAiOwnAuthPath, M as defaultDesktopAuthCandidates, N as defaultDesktopAuthPath, O as WORKBUDDYAI_AUTH_FILENAME, P as parseWorkBuddyAiAuth, S as normalizeCredits, T as PROBE_EFFORT_CANDIDATES, _ as parseProductConfig, a as readHostHeartbeat, b as classifyUpstreamError, c as WORKBUDDYAI_CONNECT_VERSION, d as composeCatalog, f as BUILTIN_FREE_MODELS, g as loadProductConfig, h as freeModelIds, i as processStartTimeMs, j as WorkBuddyAiCredentialStore, k as WORKBUDDYAI_AUTH_FILE_ENV, l as FALLBACK_WORKBUDDYAI_MODELS, m as FALLBACK_FREE_MODEL_IDS, n as clearHostHeartbeat, o as workbuddyAiHostHeartbeatPath, p as FALLBACK_EXTRA_MODELS, r as isHeartbeatProcessAlive, s as writeHostHeartbeat, t as WORKBUDDYAI_HOST_HEARTBEAT_FILENAME, u as WorkBuddyAiCatalog, v as workbuddyAiProductConfigPath, w as regionOf, x as isFreeCredits, y as WorkBuddyAiUpstreamClient } from "./host-heartbeat-BJaBFg8P.js";
...
//#endregion
export { BUILTIN_FREE_MODELS, Config, FALLBACK_EXTRA_MODELS, FALLBACK_FREE_MODEL_IDS, FALLBACK_WORKBUDDYAI_MODELS, PROBE_EFFORT_CANDIDATES, WORKBUDDYAI_AUTH_FILENAME, WORKBUDDYAI_AUTH_FILE_ENV, WORKBUDDYAI_CONTROL_PATH, WORKBUDDYAI_DESKTOP_AUTH_BASENAME, WORKBUDDYAI_DISPLAY_NAME, WORKBUDDYAI_HOST_HEARTBEAT_FILENAME, WORKBUDDYAI_PROBE_FILENAME, WORKBUDDYAI_PROVIDER, WORKBUDDYAI_SETTINGS_NS, WORKBUDDYAI_STATUS_PATH, WorkBuddyAiCatalog, WorkBuddyAiCredentialStore, WorkBuddyAiProbeService, WorkBuddyAiProbeStore, WorkBuddyAiUpstreamClient, apply, classifyUpstreamError, clearHostHeartbeat, composeCatalog, createWorkBuddyAiAdapter, createWorkBuddyAiShim, defaultDesktopAuthCandidates, defaultDesktopAuthPath, fingerprintModel, freeModelIds, inject, isFreeCredits, isHeartbeatProcessAlive, loadProductConfig, name, normalizeCredits, parseProductConfig, parseWorkBuddyAiAuth, prepareChatBody, probeModel, processStartTimeMs, randomSentinel, readHostHeartbeat, reasoningFields, regionOf, workbuddyAiHostHeartbeatPath, workbuddyAiOwnAuthPath, workbuddyAiProbePath, workbuddyAiProductConfigPath };
